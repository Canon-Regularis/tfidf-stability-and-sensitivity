...
% Without this guard the report simply fails to build from a clean checkout,
% which is a poor property for the document that is meant to be the deliverable.
