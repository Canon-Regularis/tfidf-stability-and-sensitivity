...
Usage::
    ...
    python -m tooling.mutation_python src/tfidf_stability/ranking/tie_groups.py \\
...
from tooling.allowlist import claims_python, parse_python, without_stamp
...
_CONSTANTS: dict[tuple[type, object], int | float] = {
    (int, 0): 1,
    (int, 1): 0,
    (int, 2): 1,
    (float, 0.0): 1.0,
